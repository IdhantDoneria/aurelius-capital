...
**Aurelius Capital, 2026-08-03.** One-page answer to the campaign question, from
14 backtests on real US + India equities (2014–2026), frozen platform, no tuning.

## The question

> Under what conditions does momentum exist, how faithfully can Aurelius reproduce
> the academic literature, and is Aurelius ready to deploy a momentum strategy on
> objective evidence?
...
| Aurelius reproduces JT directionally | **YES** (0 defects) |
