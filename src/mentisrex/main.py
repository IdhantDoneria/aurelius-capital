"""Mentisrex Capital — application factory.
...
from mentisrex.intelligence.api import router as intel_router
from mentisrex.knowledge import hooks as kg_hooks
...
def create_app() -> FastAPI:
    ...
    # ── Exception handlers ────────────────────────────────────────────────────
    @app.exception_handler(MentisrexError)
    async def mentisrex_error_handler(request: Request, exc: MentisrexError) -> JSONResponse:
        logger.warning(
            "handled_exception",
