...
class AuditRecord:
    ...
    python_version: str
    platform: str
    mentisrex_commit: str  # git short hash; "unknown" if not in a git repo
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "mentisrex_commit": self.mentisrex_commit,
...
_REPO_ROOT = Path(__file__).parent.parent.parent.parent  # mentisrex-capital/
