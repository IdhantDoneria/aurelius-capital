"""Phase-8 portfolio construction: many weak signals -> one robust book.
    ...
    from mentisrex.construction import PortfolioBuilder, Method, RawSignal, SignalSource
...
from mentisrex.construction.aggregation import RawSignal, SignalAggregator, SignalSource
from mentisrex.construction.builder import Method, PortfolioBuilder, TargetPortfolio
from mentisrex.construction.exposure import ExposureLimits, apply_limits
from mentisrex.construction.optimize import (
    condition_number,
...
from mentisrex.construction.sizing import equal_weight, risk_parity, volatility_target
