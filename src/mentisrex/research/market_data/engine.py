...
from mentisrex.research.market_data.bootstrap import BootstrapResult, CurveBootstrapper
...
class MarketDataEngine:
    def __init__(
        ...
        *,
        ...
        self.normalizer = Normalizer(
            id_map=id_map, fx_provider=fx_provider, base_currency=base_currency
        )
    ...
    def bootstrap_curve(
        self, instruments, *, as_of: date, curve_id: str = "curve", currency: str = "USD"
    ) -> BootstrapResult:
    ...
    def pipeline(
        ...
        *,
        ...
        raw=None,
        source=None,
        curve_instruments=None,
        smiles=None,
        curve_id: str = "curve",
        currency: str = "USD",
        surface_underlying: str = "",
        vol_model: VolModel = VolModel.SVI,
        dividend_yields=None,
        forwards=None,
        policy: PITPolicy | None = None,
    ) -> BuildResult:
        ...
        if curve_instruments:
            res = self.bootstrap_curve(
                curve_instruments, as_of=as_of, curve_id=currency, currency=currency
            )
