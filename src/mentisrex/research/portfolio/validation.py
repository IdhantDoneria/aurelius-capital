    ...
    *,
    ...
    checks = {
        "turnover": {
            ...
            "ok": constraints.max_turnover is None
            or portfolio.turnover <= constraints.max_turnover + 1e-9,
        },
        "capacity": {
            ...
            "ok": (
                constraints.max_adv_participation is None
        ...
        "concentration": {
            ...
            "ok": portfolio.diagnostics.get("max_weight", 0.0)
            <= constraints.max_position_weight + 1e-9,
        },
        "risk_exposure": {
            "volatility": vol if vol is not None else portfolio.expected_risk,
            "target": constraints.volatility_target,
            "ok": (
                constraints.volatility_target is None
