...
from mentisrex.infrastructure.database.models import (  # noqa: F401
    fundamental,
    market,
    reference,
    research,
...
def get_url() -> str:
    ...
    name = os.environ.get("DATABASE_NAME", "mentisrex_dev")
    user = os.environ.get("DATABASE_USER", "mentisrex")
