"""Exception hierarchy for Mentisrex Capital.

All custom exceptions inherit from MentisrexError.
...
class MentisrexError(Exception):
...
class ConfigurationError(MentisrexError):
...
class InfrastructureError(MentisrexError):
...
class DomainError(MentisrexError):
