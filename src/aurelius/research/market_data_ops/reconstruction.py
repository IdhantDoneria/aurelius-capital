...
rebuild the exact immutable market state Aurelius would have known — nothing knowable only after
...
from aurelius.research.market_data.quality import MarketDataQualityEngine
