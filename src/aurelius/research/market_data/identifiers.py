...
class IdentifierMap:
    ...
    def add(self, id_type: IdType, value: str, security_id: str, *,
            start: date | None = None, end: date | None = None) -> IdentifierRecord:
        ...
        for r in self._records:
            if r.id_type is rec.id_type and r.value == rec.value and r.security_id != rec.security_id:
    ...
    def resolve(self, id_type: IdType, value: str, *, as_of: date | None = None) -> str:
        matches = {r.security_id for r in self._records
