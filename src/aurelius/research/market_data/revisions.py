...
conflate and dangerous to mix in research:
  ...
  - **known_as_of(effective_date, knowledge_date)** — "what did Aurelius *know* on that day?"
...
class RevisionStore:
    ...
    def known_as_of(self, security_id: str, field: str, effective_date: date,
        ...
        """The value Aurelius knew on `knowledge_date` — latest revision published by then."""
        best = None
