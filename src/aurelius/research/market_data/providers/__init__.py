...
from aurelius.research.market_data.registry import ComponentInfo, ComponentKind
from aurelius.research.market_data_ops.registry import default_ops_registry
...
QLIB = ProviderMetadata(
    ...
    license="MIT (qlib); Aurelius data: internal",
    coverage="Aurelius datasets exported in Qlib-compatible format",
