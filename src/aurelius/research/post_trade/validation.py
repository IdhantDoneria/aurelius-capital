...
from aurelius.research.post_trade import monitoring
from aurelius.research.post_trade.models import SettlementStatus
...
def check_determinism(run_fn, *, n: int = 2) -> bool:
    from aurelius.research.post_trade.diagnostics import fingerprint
