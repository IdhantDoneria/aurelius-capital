...
from aurelius.research.post_trade.validation import ValidationResult
from aurelius.research.post_trade.validation import validate_engine as _m15_validate
...
def check_determinism(build_fn, *, n: int = 2) -> bool:
    ...
    from aurelius.research.fx.diagnostics import fingerprint
