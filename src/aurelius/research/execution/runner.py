...
from aurelius.research.execution.hooks import HookRegistry
from aurelius.research.execution.pipeline import run_pipeline
from aurelius.research.execution.scheduler import Scheduler
...
from aurelius.research.execution.validator import ValidationError, validate
from aurelius.research.experiment_registry import ExperimentRegistry
...
def make_backtest_executor(strategy, data_feed, backtest_config=None):
    ...
    def executor(session):
        from aurelius.backtesting import BacktestEngine
